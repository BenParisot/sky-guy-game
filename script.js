window.addEventListener('load', function(){
        ...
        //creates player and defines its properties
         ...
         update(input, deltaTime, enemies){
            ...
            enemies.forEach(enemy => {
                ...
                const dy = (enemy.y + this.height/2) - (this.y + this.height/2);
    ...
    class Enemy {
        ...
        draw(context){
            ...
            context.stroke();
            context.drawImage(this.image, this.frameX * this.width, 0, this.width, this.width, this.x, this.y, this.width, this.height);
        }
        update(deltaTime){
            if (this.frameTimer > this.frameInterval) {
                if (this.frameX >= this.maxFrame) this.frameX = 0;
